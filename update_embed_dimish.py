...
def update_embedding(emb_table, n_class, text_final, word_index, label, emb_dim, word_list, test_pad_encoded, label_encoded, text_pad_encoded, alpha):
...
def update_embedding0(emb_table, n_class, text_final, word_index, label, emb_dim, word_list, test_pad_encoded, label_encoded, text_pad_encoded,alpha):
  # model for Text
  import torch
  import torch.nn as nn
  import torch.optim as optim
...
def update_embedding1(emb_table, n_class, text_final, word_index, label, emb_dim, word_list, test_pad_encoded, label_encoded, text_pad_encoded, alpha):
  # model for Text
  import torch
  import torch.nn as nn
  import torch.optim as optim
...
def update_embedding2(emb_table, n_class, text_final, word_index, label, emb_dim, word_list, test_pad_encoded, label_encoded, text_pad_encoded, alpha):
  # model for Text
  import torch
  import torch.nn as nn
  import torch.optim as optim
...
def update_embedding3(emb_table, n_class, text_final, word_index, label, emb_dim, word_list, test_pad_encoded, label_encoded, text_pad_encoded, alpha):
  # model for Text
  import torch
  import torch.nn as nn
  import torch.optim as optim
