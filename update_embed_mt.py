...
def update_embedding(emb_table, n_class, emb_dim, word_list, train_pad_encoded, label_train_encoded, test_pad_encoded, label_test_encoded):
...
def update_embedding0(emb_table, n_class, emb_dim, word_list, train_pad_encoded, label_train_encoded, test_pad_encoded,
                       label_test_encoded):
  # model for Text
  import torch
  import torch.nn as nn
...
def update_embedding1(emb_table, n_class, emb_dim, word_list, train_pad_encoded, label_train_encoded,
                         test_pad_encoded, label_test_encoded):
  # model for Text
  import torch
  import torch.nn as nn
  import torch.optim as optim
