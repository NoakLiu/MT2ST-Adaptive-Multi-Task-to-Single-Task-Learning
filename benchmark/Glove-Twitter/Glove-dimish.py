...
from func_plot import plot2D_accuracy, plot2D_loss, plot2D2
...
if(mode=="mt"):
    ...
    update_modes = update_embed_mt2st_dimish
...
if(update_modes!="mt2st_switch"):
    ...
    plot2D2(epoches1, losses_previous, epoches2, losses_after, "Epoches", "Accuracy",
